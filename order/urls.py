...
from .views import home, produces,production, order_infos,planning,confirm_order, order_confirmed, login, signin,sous_traitants, account, order_history, logout, contact,fournisseurs, employees,stock_management,catalog_management,client_management,order_management,warehouse_management # Ajout de employees
urlpatterns = [
